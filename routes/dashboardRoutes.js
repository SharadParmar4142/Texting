...
const { 
  ...
  notifyAllInbox, notifyByTypeInbox, notifyByIdInbox, listPendingListeners, approveListener, rejectListener
...
// Pending Listeners
router.get("/pendingListeners", validateToken, adminCheck, listPendingListeners);
router.post("/approveListener/:id", validateToken, adminCheck, approveListener);
router.delete("/rejectListener/:id", validateToken, adminCheck, rejectListener);
